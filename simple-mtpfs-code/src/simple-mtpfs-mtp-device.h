...
public:
    ...
    bool connect(int bus_node, int dev_node);
    ...
    const TypeDir *dirFetchContent(const std::string &path);
#endif /* _PIDST_MODIFIED_SIMPLEMTPFS_ */
...
#else /* _PIDST_MODIFIED_SIMPLEMTPFS_ */
    bool connect_priv(int dev_no, int bus_node, int dev_node, const std::string &dev_file);
#endif /* _PIDST_MODIFIED_SIMPLEMTPFS_ */

#if 1 /* _PIDST_MODIFIED_SIMPLEMTPFS_ */
    bool isMediaFile(const LIBMTP_file_t &file);
#endif /* _PIDST_MODIFIED_SIMPLEMTPFS_ */
...
private:
    ...
    TypeDir m_root_dir;
#if 1 /* _PIDST_MODIFIED_SIMPLEMTPFS_ */
    std::string m_dirfetchcontent_path;
    TypeDir *m_dirfetchcontent_dir;
#endif /* _PIDST_MODIFIED_SIMPLEMTPFS_ */
    bool m_move_enabled;
